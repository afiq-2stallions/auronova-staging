...
class UAEL_Config {
		...
		if ( null === self::$widget_list ) {
			...
			self::$widget_list = array(
				...
				'Advanced_Search'     => array(
					'slug'        => 'uael-advanced-search',
					'title'       => __( 'Advanced Search', 'uael' ),
					'description' => __( 'Create advanced search functionality with live results and filters.', 'uael' ),
					'keywords'    => array( 'uael', 'search', 'advanced', 'ajax', 'live', 'filter' ),
					'icon'        => 'uael-icon-advanced-search',
					'title_url'   => '#',
					'default'     => true,
					'doc_url'     => UAEL_DOMAIN . 'docs-category/widgets/advanced-search/?utm_source=uael-pro-dashboard&utm_medium=uael-menu-page&utm_campaign=uael-pro-plugin',
					'category'    => 'content',
					'is_pro'      => true,
					'demo_url'    => UAEL_DOMAIN . 'widgets/advanced-search/',
				),
				'Post_Duplicator'     => array(
					'slug'        => 'uael-post-duplicator',
					'title'       => __( 'Duplicator', 'uael' ),
					'description' => __( 'Duplicate any post, page, or custom post type with one click.', 'uael' ),
					'keywords'    => array( 'uael', 'duplicate', 'copy', 'clone', 'post', 'page' ),
					'icon'        => 'uael-icon-cdcp',
					'title_url'   => '#',
					'default'     => false,
					'doc_url'     => UAEL_DOMAIN . 'docs/duplicator/?utm_source=uael-pro-dashboard&utm_medium=uael-menu-page&utm_campaign=uael-pro-plugin',
					'category'    => 'extension',
					'is_pro'      => true,
					'demo_url'    => UAEL_DOMAIN . 'widgets/duplicator/',
				),
	...
	public static function get_widget_script() {
		...
		$js_files = array(
			...
			'uael-advanced-search'   => array(
				'path'      => 'assets/' . $folder . '/uael-advanced-search' . $suffix . '.js',
				'dep'       => array( 'jquery' ),
				'in_footer' => true,
			),
			/* Libraries */
