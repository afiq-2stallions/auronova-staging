	...
	public function get_reviewer_name( $review, $settings ) {
		if ( 'yes' === $this->get_instance_value( 'reviewer_name' ) ) {
			...
			<?php if ( 'yes' === $this->get_instance_value( 'reviewer_name_link' ) ) { ?>
				<span class="uael-reviewer-name"><a href="<?php echo esc_url( $review['author_url'] ); ?>" target="_blank" rel="noopener noreferrer"><?php echo esc_html( $review['author_name'] ); ?></a></span>
			<?php } else { ?>
				<span class="uael-reviewer-name"><?php echo esc_html( $review['author_name'] ); ?></span>
				<?php
			}
		}
	}
